...
map.getView().fit([9471939.593530, 2948907.554528, 9473990.053159, 2950160.379478], map.getSize());
...
var Title = new ol.control.Control({
    element: (() => {
        ...
        titleElement.innerHTML = '<h2 class="project-title">Sanjay Gandhi Biological Park</h2>';
        return titleElement;
    })(),
